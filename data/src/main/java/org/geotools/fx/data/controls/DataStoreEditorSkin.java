...
class DataStoreEditorSkin extends SkinBase<DataStoreEditor> {
    ...
    private List<PropertySheet.Item> userItems;

    private List<PropertySheet.Item> advancedItems;

    private List<PropertySheet.Item> programItems;
                                ...
                                log.fine(
                                        () ->
                                                String.format(
                                                        ...
                                                        item.getType(),
                                                        item.getValue())))
                .forEach(propertySheet.getItems()::add);
    }
    ...
    private List<Item> createCategoryItems(List<Parameter> params) {
        return params.stream().map(ParameterItem::of).toList();
    }
}
